...
class Launcher:
    def __init__(self, callee, run_config=None, return_all=False,tracker_config=None):
        self.callee = callee
    ...
    def launch(self, custom_config, *args):
        ...
        for new_rank in range(0, self.nranks):
            ...
            args_ = (self.callee, port, return_value_queue, new_config,self.tracker_config, *args)
...
def setup_new_process(callee, port, return_value_queue, config,tracker_config, *args):
    print_memory_stats()
