...
class BaseTracker:
    ...
    def log_artifact(self, 
        ...
        # If artifact manager is provided, use it
        if self.artifact_manager:
            ...
            # Simple file copy if no artifact manager
            artifact_dir = self.log_dir / "artifacts" / artifact_type
            os.makedirs(artifact_dir, exist_ok=True)
            
            dest_path = artifact_dir / name
